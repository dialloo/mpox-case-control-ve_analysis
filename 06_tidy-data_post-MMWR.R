...
raw <- here("data", "MultiJurisdictionalM_DATA_2023-04-28_1028.csv") %>%
read_csv()
...
#MultiJurisdictionalM_DATA_2023-06-07_1109
...
mpoxve <- raw %>%    
  ...
  mutate( #! Variable name key: 
    ...
    redcap_trans_date       = ymd("2023-04-28"),
...
# mmwr_dates <- mpoxve %>%
#   rename_with( .fn = function(.x){paste0("mmwr_", .x)},
#                .cols=c(caco, caco_stat_cat, vax_stat_ve_main, vax_scenario, index_date, test_result_date, symptoms_date,
#                        clinic_date, control_visit_date, first_dose_date, second_dose_date,
#                        dose1_date, dose2_date
#                        )) %>%
#   select(jid, pid, mmwr_caco, mmwr_caco_stat_cat, mmwr_vax_stat_ve_main, mmwr_vax_scenario, mmwr_index_date, mmwr_test_result_date, mmwr_symptoms_date,
#          mmwr_clinic_date, mmwr_control_visit_date, mmwr_first_dose_date, mmwr_dose1_date,
#          mmwr_second_dose_date, mmwr_dose2_date)
# 
# saveRDS(mmwr_dates, "data/mmwr_dates.RDS")
